...
package com.rivetlogic.speech.corejsp;
...
@Component(
	immediate = true,
	property = {
		"context.id=SpeechCustomJspBag", "context.name=Speech Custom JSP Bag",
		"service.ranking:Integer=100"
	}
)
public class SpeechCustomJspBag implements CustomJspBag {
	...
	/**
	 * Adds the URL paths for all custom core JSPs and JS to a list when the module is
	 * activated.
	 *
