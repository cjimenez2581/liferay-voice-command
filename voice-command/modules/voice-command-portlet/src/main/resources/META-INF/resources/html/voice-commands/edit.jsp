...
String keyWord = preference.getValue(SpeechCommandPortletKeys.KEY_PHRASE, StringPool.BLANK);

String commandKey = ParamUtil.getString(request, SpeechCommandPortletKeys.VOICE_COMMAND, StringPool.BLANK);
String commandValue = ParamUtil.getString(request, SpeechCommandPortletKeys.VOICE_COMMAND_VALUE, StringPool.BLANK);
...
<aui:container>
	<aui:row>
		<aui:col width="100">
			...
			<portlet:actionURL var="backURL" portletMode="<%= LiferayPortletMode.VIEW.toString() %>"
...
<aui:script use="aui-tooltip">
    new A.TooltipDelegate(
      {
        trigger: '#${pns}fm input[type=text]',
        position: 'right'
      }
    );
</aui:script>
